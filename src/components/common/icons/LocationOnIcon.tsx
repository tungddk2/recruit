...
const LocationOnSVG = () => (
	<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 96 960 960" width="1rem" height="1rem">
...
export const LocationOnIcon = (props: Partial<CustomIconComponentProps>) => (
	<Icon component={LocationOnSVG} {...props} />
)